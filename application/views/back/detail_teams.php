                                        ...
                                        <div class="col-sm-12">
                                            <span class="float-center">
                                                ...
                                                <img src="<?=base_url()?>assets/data/users/<?=isset($user->gambar) ? $user->gambar : 'default.jpg' ?>" style="display: block;object-fit: cover;" alt=""
                                                    ...
                                                    <?php if ($this->session->userdata('status') == 'ketua') { ?>
                                            ...
                                            <div class="media-body text-center">
                                                <h5 class="mt-2 mb-1 text-white font-10"><?=$user->nama?></h5>
                                                <?php if ($this->session->userdata('status') == 'ketua') { ?>
                                                <form method="post">
                                                <input type="hidden" name="id" value="<?=$user->id_user?>">
                                                <select class="selectpicker show-tick mt-3" name="levelUser" onchange="this.form.submit()" data-style="btn-secondary btn-sm">
                                                    <option value="0" <?php if($user->level_user == 0){ echo 'selected'; }?>>Anggota</option>
                                                    <option value="1" <?php if($user->level_user == 1){ echo 'selected'; }?>>Ketua</option>
                                                    <option value="2" <?php if($user->level_user == 2){ echo 'selected'; }?>>Wakil Ketua</option>
                                                    <option value="3" <?php if($user->level_user == 3){ echo 'selected'; }?>>Sekretaris</option>
                                                </select>
                                                </form>
                                                <?php } ?>
                                            </div>
                                                    ...
                                                    <div class="tab-pane fade" id="v2-settings" role="tabpanel" aria-labelledby="v2-settings-tab">
                                                        ...
                                                        <br>
                                                            ...
                                                            <form method="POST" name="form">
                                                                ...
                                                                <button name="updateUser" style="all: unset" id="sa-hapus" data-toggle="tooltip" title="Hapus akun ?"><i class="fa fa-trash-alt text-muted " style="cursor: pointer;"></i> </button>
                                                            </form>
                                                    </div>
                                                    <?php } ?>
                                                </div>
