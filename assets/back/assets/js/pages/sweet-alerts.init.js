...
t("#sa-verifikasi").click(function (e) { 
    ...
    Swal.fire({
        ...
        if (result.value) {
            t.value && Swal.fire("Berhasil!", "Pendaftar sudah diverifikasi.", "success")
            document.forms.form.submit();
        }
    })
}), t("#sa-hapus").click(function (e) {
    e.preventDefault();
    Swal.fire({
        title: "Apakah anda yakin?",
